...
const asw1 = 'https://ibb.co/9bkrzwh'
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`9177367031163@s.whatsapp.net`]
...
cmhit.push(command)
    //MESS
    mess = {
      wait: " 5 𝙉𝙞𝙢𝙞𝙨𝙝𝙖𝙢 𝙒𝙖𝙞𝙩 𝘾𝙝𝙚𝙮𝙪 𝙎𝙚𝙍",
      success: "Success シ︎",
...
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/917736703116?text=hello`}}})
		}*/
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FN5WnbncDGS0qXLuCB2ypy', "groupName": `Thakkudu Bot Inc.`, "footerText": "*_𝐓𝐡𝐚𝐤𝐤𝐮𝐝𝐮 𝐁𝐨𝐭_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`𝐓𝐡𝐚𝐤𝐤𝐮𝐝𝐮 𝐁𝐨𝐭`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":false},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*JiHaaD*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             xeon.relayWAMessage(res)
        }
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, externalAdReply:{title: `Xeon`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/917736703116?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝐓𝐡𝐚𝐤𝐤𝐮𝐝𝐮 𝐁𝐨𝐭. (@i_am.jhad_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://ibb.co/bKWMNkk",
                "thumbnail": fake,
                "sourceUrl": ``
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/917736703116`,
                "mediaType": "10",
                "mediaUrl": `wa.me/917736703116`,
                "thumbnailUrl": "https://ibb.co/bKWMNkk",
                "thumbnail": iye,
                "sourceUrl": `wa.me/917736703116`,
...
"mediaType": "2",
"thumbnailUrl": "https://ibb.co/bKWMNkk",
"mediaUrl": "https://youtube.com/channel/JIDMODSYT",
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`));
        let fil = vote.map((v) => v.participant);
        let id_vote = sender ? sender : "917736703116@s.whatsapp.net";
        if (fil.includes(id_vote)) {
          return mentions(
            "@" + sender.split("@")[0] + " You have voted",
            fil,
...
*Thank you for registering in the Thakkudu Vava Database*
...
*「 THAKKUDU V2 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered JiHaaD SeR*`)
		}, 2000)
        break
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "917736703116@s.whatsapp.net"
        dtod = '917736703116'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              xeon.sendMessage('917736703116@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://www.instagram.com/i_am.jhad_/')
break
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "body": "",
                "previewType": "PHOTO",
                "thumbnail":"https://ibb.co/bKWMNkk",
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `Thakkudu V2`, [
          {
            buttonId: `command`,
            buttonText: {
...
`
sendButMessage(from, menu, `Thakkudu Vava`, [
          {
            buttonId: `command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
case 'script':
		case 'sc':
		case 'sourcecode':
		xeon.sendMessage(from, { text: "https://github.com/J-I-H-A-D/Thakkudu-V2", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: false}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
break
//fun features by jihaad
                case 'uglycheck':
					// source code by jihad⛔
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
                  sange = body.slice(1)
...
case 'hacked':
  if (!mek.key.fromMe) return;
              ...
              if (args.length < 1) return reply('The text?')
              reply('Otw Hack')
                tessgc = await getBuffer(`https://ibb.co/dJ617xz`)
...
case 'mygithub':
  reply('https://github.com/J-I-H-A-D/Thakkudu-V2')
					break;
   case 'ss':
      reply(mess.wait)
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/J-I-H-A-D/Thakkudu-V2"
        },
        "index": 0
      }
    ]
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'Thakkudu V2', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `Thakkudu Vava`, [
            {              
...
buttons = [{buttonId: `yuri`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'Thakkudu Vava', imageMessage: imageMsg,
              contentText:`ɴᴏᴛᴇ: ʜᴏʀɴʏ = ʙᴏɴᴋs`,buttons,headerType:4}
              prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              xeon.relayWAMessage(prep)
break
...
buttons = [{buttonId: `bj`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'JiHaaD', imageMessage: imageMsg,
              contentText:`ɴᴏᴛᴇ: ʜᴏʀɴʏ = ʙᴏɴᴋs`,buttons,headerType:4}
              prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              xeon.relayWAMessage(prep)
break
...
case 'writelist':
  ...
  🌿 ${prefix}write JiHaaD 
  🌿 ${prefix}folioright JiHaaD 
  🌿 ${prefix}folioleft JiHaaD 
  🌿 ${prefix}writedown JiHaaD 
  🌿 ${prefix}writeleft JiHaaD`)
  break
case 'folioleft':
if (!c) return reply('Where is the text bro??')
reply(mess.wait)
